...
import { MessageCircle, Search, User, Users, X } from "lucide-react";
...
export const ChatList: React.FC<ChatListProps> = React.memo(
            ...
            <ScrollArea className="h-full pr-2">
              <div className="space-y-2">
                ...
                {!isMembersLoading &&
                  ...
                  (() => {
                    const filteredMembers = membersData.documents.filter(
                      (member: Member) => {
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-xs text-muted-foreground truncate">
                              <span
                                dangerouslySetInnerHTML={{
                                  __html: highlightText(member.email),
                                }}
                              />
  ...
  (prevProps, nextProps) => {
    ...
    return (
      ...
      prevProps.chats.every(
        (chat, index) => chat.$id === nextProps.chats[index].$id
      )
    );
  }
);
